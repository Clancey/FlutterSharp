...
namespace FlutterSharp.CodeGen.TypeMapping
{
	...
	public class TypeMappingRegistry
	{
		...
		private void RegisterCallbackTypes()
		{
			...
			RegisterMapping(new TypeMapping
			{
				DartType = "WidgetBuilder",
				CSharpType = "Func<BuildContext, Widget>",
				DartStructType = "Pointer<Utf8>",
				DartParserFunction = "parseWidgetBuilder",
				Package = "flutter/widgets",
				RequiresCustomMarshalling = true
			});
			...
			RegisterMapping(new TypeMapping
			{
				DartType = "IndexedWidgetBuilder",
				CSharpType = "Func<BuildContext, int, Widget>",
				DartStructType = "Pointer<Utf8>",
				DartParserFunction = "parseIndexedWidgetBuilder",
				Package = "flutter/widgets",
				RequiresCustomMarshalling = true
			});
			...
			RegisterMapping(new TypeMapping
			{
				DartType = "TransitionBuilder",
				CSharpType = "Func<BuildContext, Widget?, Widget>",
				DartStructType = "Pointer<Utf8>",
				DartParserFunction = "parseTransitionBuilder",
				Package = "flutter/widgets",
				RequiresCustomMarshalling = true
			});

			// AnimatedWidgetBuilder: Widget Function(BuildContext, Animation<double>)
			// Note: Animation<double> is mapped to object for now since Animation is not a simple type
			RegisterMapping(new TypeMapping
			{
				DartType = "AnimatedWidgetBuilder",
				CSharpType = "Func<BuildContext, object, Widget>",
				DartStructType = "Pointer<Utf8>",
				DartParserFunction = "parseAnimatedWidgetBuilder",
				Package = "flutter/widgets",
				RequiresCustomMarshalling = true
			});
			...
			RegisterMapping(new TypeMapping
			{
				DartType = "NullableIndexedWidgetBuilder",
				CSharpType = "Func<BuildContext, int, Widget?>",
				DartStructType = "Pointer<Utf8>",
				DartParserFunction = "parseNullableIndexedWidgetBuilder",
				Package = "flutter/widgets",
				RequiresCustomMarshalling = true
			});
		}
		...
		private void RegisterAdditionalFlutterTypes()
		{
			...
			RegisterMapping(new TypeMapping
			{
				...
				CSharpType = "Flutter.Navigation.RouteSettings",
				DartStructType = "Pointer<Void>",
