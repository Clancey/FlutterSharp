...
/// * [Canvas], the class that a custom painter uses to paint.
	...
	{
		// Has flag for nullable property: painter
		public byte Haspainter { get; set; }

		// Nullable field: painter
		private IntPtr _painter;

/// The painter that paints before the children.
		public IntPtr painter
		{
			get => _painter;
			set { _painter = value; Haspainter = 1; }
		}

		// Has flag for nullable property: foregroundPainter
		public byte HasforegroundPainter { get; set; }

		// Nullable field: foregroundPainter
		private IntPtr _foregroundPainter;

/// The painter that paints after the children.
		public IntPtr foregroundPainter
		{
			get => _foregroundPainter;
			set { _foregroundPainter = value; HasforegroundPainter = 1; }
		}
