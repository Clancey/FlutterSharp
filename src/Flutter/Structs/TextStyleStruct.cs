...
/// is set to null.
		...
		{
			get => _fontSize;
			set { _fontSize = value; HasfontSize = 1; }
		}

		// Has flag for nullable property: fontWeight
		public byte HasfontWeight { get; set; }

		// Nullable field: fontWeight
		private IntPtr _fontWeight;

/// The typeface thickness to use when painting the text (e.g., bold).
		public IntPtr fontWeight
		{
			get => _fontWeight;
			set { _fontWeight = value; HasfontWeight = 1; }
		}

		// Has flag for nullable property: fontStyle
		public byte HasfontStyle { get; set; }

		// Nullable field: fontStyle
...
/// bring the words closer.
		...
		{
			get => _wordSpacing;
			set { _wordSpacing = value; HaswordSpacing = 1; }
		}

		// Has flag for nullable property: textBaseline
		public byte HastextBaseline { get; set; }

		// Nullable field: textBaseline
...
/// parent text span, or, for the root text spans, with the line box.
		...
		{
			get => _textBaseline;
			set { _textBaseline = value; HastextBaseline = 1; }
		}
...
/// height at the paragraph level.
		...
		// Has flag for nullable property: leadingDistribution
		public byte HasleadingDistribution { get; set; }

		// Nullable field: leadingDistribution
		private IntPtr _leadingDistribution;
...
/// `ParagraphStyle.textHeightBehavior`'s [leadingDistribution].
		public IntPtr leadingDistribution
		{
			get => _leadingDistribution;
			set { _leadingDistribution = value; HasleadingDistribution = 1; }
		}
...
/// different region-specific glyphs for each text span.
		...
		// Has flag for nullable property: foreground
		public byte Hasforeground { get; set; }

		// Nullable field: foreground
...
/// specified in one place, it will dominate [color] in another.
		...
		{
			get => _foreground;
			set { _foreground = value; Hasforeground = 1; }
		}

		// Has flag for nullable property: background
		public byte Hasbackground { get; set; }

		// Nullable field: background
...
/// in another.
		...
		{
			get => _background;
			set { _background = value; Hasbackground = 1; }
		}
...
/// Multiple decorations can be applied using [TextDecoration.combine].
		...
		// Has flag for nullable property: decorationColor
		public byte HasdecorationColor { get; set; }

		// Nullable field: decorationColor
		private IntPtr _decorationColor;

/// The color in which to paint the text decorations.
		public IntPtr decorationColor
		{
			get => _decorationColor;
			set { _decorationColor = value; HasdecorationColor = 1; }
		}

		// Has flag for nullable property: decorationStyle
		public byte HasdecorationStyle { get; set; }

		// Nullable field: decorationStyle
		private IntPtr _decorationStyle;

/// The style in which to paint the text decorations (e.g., dashed).
		public IntPtr decorationStyle
		{
			get => _decorationStyle;
			set { _decorationStyle = value; HasdecorationStyle = 1; }
		}

		// Has flag for nullable property: decorationThickness
		public byte HasdecorationThickness { get; set; }

		// Nullable field: decorationThickness
		private double _decorationThickness;
...
/// stroke thickness/width.
		public double decorationThickness
		{
			...
			set { _decorationThickness = value; HasdecorationThickness = 1; }
		}
...
/// equivalent as order produces differing transparency.
		...
		// Nullable field: fontFeatures
		private IntPtr _fontFeatures;
...
/// * [fontVariations], for font features that have continuous parameters.
		...
		{
			get => _fontFeatures;
			set { _fontFeatures = value; HasfontFeatures = 1; }
		}

		// Has flag for nullable property: fontVariations
		public byte HasfontVariations { get; set; }

		// Nullable field: fontVariations
		private IntPtr _fontVariations;
...
/// * [fontFeatures], for font variations that have discrete values.
		public IntPtr fontVariations
		{
			get => _fontVariations;
			set { _fontVariations = value; HasfontVariations = 1; }
		}

		// Has flag for nullable property: overflow
		public byte Hasoverflow { get; set; }

		// Nullable field: overflow
...
/// How visual text overflow should be handled.
		...
		{
			get => _overflow;
			set { _overflow = value; Hasoverflow = 1; }
		}

		// Has flag for nullable property: fontFamilyFallback
		public byte HasfontFamilyFallback { get; set; }

		// Nullable field: fontFamilyFallback
		private IntPtr _fontFamilyFallback;

		public IntPtr fontFamilyFallback
		{
			get => _fontFamilyFallback;
			set { _fontFamilyFallback = value; HasfontFamilyFallback = 1; }
		}
