...
/// type for performance reasons.
		...
		// Has flag for nullable property: backdropGroupKey
		public byte HasbackdropGroupKey { get; set; }

		// Nullable field: backdropGroupKey
		private IntPtr _backdropGroupKey;

/// The [BackdropKey] that identifies the backdrop this filter will apply to.
/// 
/// The default value for the backdrop key is `null`.
		public IntPtr backdropGroupKey
		{
			get => _backdropGroupKey;
			set { _backdropGroupKey = value; HasbackdropGroupKey = 1; }
		}
