...
/// ![Diagrams with parts of the Hero transition.](https://flutter.github.io/assets-for-api-docs/assets/interaction/heroes.png)
	...
	internal class HeroStruct : SingleChildRenderObjectWidgetStruct
	{
...
/// [MaterialApp] creates a [MaterialRectArcTween].
		public IntPtr? createRectTween { get; set; }
...
/// Hero [child]'s original size.
		public IntPtr? flightShuttleBuilder { get; set; }
...
/// and will be kept [Offstage] during the Hero's flight.
		public IntPtr? placeholderBuilder { get; set; }
...
/// 
/// Defaults to false.
		public bool transitionOnUserGestures { get; set; }
