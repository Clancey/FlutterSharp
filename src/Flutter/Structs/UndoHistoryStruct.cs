...
/// the undo stack.
		...
		public string? shouldChangeUndoStackAction
		{
			...
			set { SetString(ref _shouldChangeUndoStack, value); HasshouldChangeUndoStack = (byte)(value != null ? 1 : 0); }
		}
...
/// If null then the original value will always be pushed to the stack.
		...
		public string? undoStackModifierAction
		{
			...
			set { SetString(ref _undoStackModifier, value); HasundoStackModifier = (byte)(value != null ? 1 : 0); }
		}
