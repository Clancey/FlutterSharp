...
/// of this region.
		...
		public string? onTapInsideAction
		{
			...
			set { SetString(ref _onTapInside, value); HasonTapInside = (byte)(value != null ? 1 : 0); }
		}
...
/// of this region.
		...
		public string? onTapUpInsideAction
		{
			...
			set { SetString(ref _onTapUpInside, value); HasonTapUpInside = (byte)(value != null ? 1 : 0); }
		}

		// Has flag for nullable property: groupId
		public byte HasgroupId { get; set; }

		// Nullable field: groupId
...
/// If the group id is null, then only this region is hit tested.
		...
		{
			get => _groupId;
			set { _groupId = value; HasgroupId = 1; }
		}
