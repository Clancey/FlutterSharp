...
/// * [IOSSystemContextMenuItemCustom], which creates custom menu items.
		...
		// Has flag for nullable property: onSystemHide
		public byte HasonSystemHide { get; set; }
...
/// to be hidden.
		...
		public string? onSystemHideAction
		{
			...
			set { SetString(ref _onSystemHide, value); HasonSystemHide = (byte)(value != null ? 1 : 0); }
		}
