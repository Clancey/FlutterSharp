...
/// {@end-tool}
		...
		public string? frameBuilderAction
		{
			...
			set { SetString(ref _frameBuilder, value); HasframeBuilder = (byte)(value != null ? 1 : 0); }
		}
...
/// {@animation 400 400 https://flutter.github.io/assets-for-api-docs/assets/widgets/loading_progress_image.mp4}
		...
		public string? loadingBuilderAction
		{
			...
			set { SetString(ref _loadingBuilder, value); HasloadingBuilder = (byte)(value != null ? 1 : 0); }
		}
...
/// If non-null, this color is blended with each image pixel using [colorBlendMode].
		...
		// Has flag for nullable property: opacity
		public byte Hasopacity { get; set; }

		// Nullable field: opacity
		private IntPtr _opacity;
...
/// from a single opacity value.
		...
		{
			get => _opacity;
			set { _opacity = value; Hasopacity = 1; }
		}
...
/// How to paint any portions of the layout bounds not covered by the image.
		...
		// Has flag for nullable property: centerSlice
		public byte HascenterSlice { get; set; }

		// Nullable field: centerSlice
		private IntPtr _centerSlice;
...
/// the center slice will be stretched only vertically.
		public IntPtr centerSlice
		{
			get => _centerSlice;
			set { _centerSlice = value; HascenterSlice = 1; }
		}
