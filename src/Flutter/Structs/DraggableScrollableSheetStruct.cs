...
/// [DraggableScrollableActuator.reset].
		...
		// Nullable field: snapSizes
		private IntPtr _snapSizes;
...
/// being built or since the last call to [DraggableScrollableActuator.reset].
		public IntPtr snapSizes
		{
			get => _snapSizes;
			set { _snapSizes = value; HassnapSizes = 1; }
		}

		// Has flag for nullable property: snapAnimationDuration
		public byte HassnapAnimationDuration { get; set; }

		// Nullable field: snapAnimationDuration
		private IntPtr _snapAnimationDuration;
...
/// target divided by the velocity of the widget.
		public IntPtr snapAnimationDuration
		{
			get => _snapAnimationDuration;
			set { _snapAnimationDuration = value; HassnapAnimationDuration = 1; }
		}
