...
/// A value of 0.0 (the default) indicates the center for either [axis] value.
		...
		// Nullable field: fixedCrossAxisSizeFactor
		private double _fixedCrossAxisSizeFactor;
...
/// If `null` (the default), the cross axis size is as large as the parent.
		...
		{
			get => _fixedCrossAxisSizeFactor;
			set { _fixedCrossAxisSizeFactor = value; HasfixedCrossAxisSizeFactor = 1; }
		}
