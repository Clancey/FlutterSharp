...
/// {@macro flutter.widgets.shortcuts.shortcuts}
		...
		// Has flag for nullable property: onShowFocusHighlight
		public byte HasonShowFocusHighlight { get; set; }
...
/// This method is not triggered at the unmount of the widget.
		...
		public string? onShowFocusHighlightAction
		{
			...
			set { SetString(ref _onShowFocusHighlight, value); HasonShowFocusHighlight = (byte)(value != null ? 1 : 0); }
		}

		// Has flag for nullable property: onShowHoverHighlight
		public byte HasonShowHoverHighlight { get; set; }
...
/// This method is not triggered at the unmount of the widget.
		...
		public string? onShowHoverHighlightAction
		{
			...
			set { SetString(ref _onShowHoverHighlight, value); HasonShowHoverHighlight = (byte)(value != null ? 1 : 0); }
		}
