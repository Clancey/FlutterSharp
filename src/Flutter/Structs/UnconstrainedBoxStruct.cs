...
/// * [AlignmentDirectional] for [Directionality]-aware alignments.
		...
		// Has flag for nullable property: constrainedAxis
		public byte HasconstrainedAxis { get; set; }

		// Nullable field: constrainedAxis
...
/// will be retained.
		public Axis constrainedAxis
		{
			...
			set { _constrainedAxis = value; HasconstrainedAxis = 1; }
		}
