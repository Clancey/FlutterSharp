...
/// This will not be called if a [TreeSliverNode] does not have any children.
		...
		public string? onNodeToggleAction
		{
			...
			set { SetString(ref _onNodeToggle, value); HasonNodeToggle = (byte)(value != null ? 1 : 0); }
		}

		// Has flag for nullable property: toggleAnimationStyle
		public byte HastoggleAnimationStyle { get; set; }

		// Nullable field: toggleAnimationStyle
		private IntPtr _toggleAnimationStyle;
...
/// To disable the tree animation, use [AnimationStyle.noAnimation].
		public IntPtr toggleAnimationStyle
		{
			get => _toggleAnimationStyle;
			set { _toggleAnimationStyle = value; HastoggleAnimationStyle = 1; }
		}
