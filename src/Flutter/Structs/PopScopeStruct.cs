...
/// * [Route.onPopInvokedWithResult], which is similar.
		...
		public string? onPopInvokedWithResultAction
		{
			...
			set { SetString(ref _onPopInvokedWithResult, value); HasonPopInvokedWithResult = (byte)(value != null ? 1 : 0); }
		}
...
/// successfully.
		...
		public string? onPopInvokedAction
		{
			...
			set { SetString(ref _onPopInvoked, value); HasonPopInvoked = (byte)(value != null ? 1 : 0); }
		}
