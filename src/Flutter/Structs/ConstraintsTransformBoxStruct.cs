...
/// * [AlignmentDirectional] for [Directionality]-aware alignments.
		...
		// Callback field: constraintsTransform
		// Using action string pattern - Dart will dispatch action to C# via method channel
		IntPtr _constraintsTransform;
...
/// {@endtemplate}
		/// <summary>
		/// Action identifier for constraintsTransform callback.
		...
		/// </summary>
		public string? constraintsTransformAction
		{
			get => GetString(_constraintsTransform);
			set { SetString(ref _constraintsTransform, value); }
		}
