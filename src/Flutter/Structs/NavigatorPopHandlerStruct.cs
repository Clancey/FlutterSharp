...
/// Defaults to true.
		...
		// Has flag for nullable property: onPop
		public byte HasonPop { get; set; }
...
/// code on [NavigatorPopHandler] for a full example of this.
		...
		public string? onPopAction
		{
			...
			set { SetString(ref _onPop, value); HasonPop = (byte)(value != null ? 1 : 0); }
		}
...
/// The passed `result` is the result of the popped [Route].
		...
		public string? onPopWithResultAction
		{
			...
			set { SetString(ref _onPopWithResult, value); HasonPopWithResult = (byte)(value != null ? 1 : 0); }
		}
