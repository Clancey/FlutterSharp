...
/// * The [catalog of layout widgets](https://flutter.dev/widgets/layout/).
	public class LayoutBuilder : Widget
	{
		...
		public LayoutBuilder(
			Func<BuildContext, BoxConstraints, Widget> builder = null
		)
		{
			var s = GetBackingStruct<LayoutBuilderStruct>();
			// Complex callback type: Func<BuildContext, BoxConstraints, Widget> - skipped (requires specific marshaling)
		}
