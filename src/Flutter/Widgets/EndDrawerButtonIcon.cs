...
/// * [ThemeData.platform], which specifies the current platform.
	...
	{
		/// <summary>
		/// Initializes a new instance of the <see cref="EndDrawerButtonIcon"/> class.
		/// </summary>
		public EndDrawerButtonIcon(
		)
		{
			var s = GetBackingStruct<EndDrawerButtonIconStruct>();
		}

		protected override FlutterObjectStruct CreateBackingStruct() => new EndDrawerButtonIconStruct();
	}
}
