...
/// changes for subparts of the value.
	...
	{
		/// <summary>
		/// Initializes a new instance of the <see cref="InheritedWidget"/> class.
		/// </summary>
		public InheritedWidget(
		)
		{
			var backingStruct = GetBackingStruct<InheritedWidgetStruct>();
		}

		protected override FlutterObjectStruct CreateBackingStruct() => new InheritedWidgetStruct();
	}
}