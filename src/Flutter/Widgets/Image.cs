...
/// * Cookbook: [Fade in images with a placeholder](https://docs.flutter.dev/cookbook/images/fading-in-images)
	public class Image : StatefulWidget
	{
		...
		public Image(
			...
			Func<BuildContext, Widget, object?, Widget> loadingBuilder = null,
		...
		)
		{
			...
			// Complex callback type: Func<BuildContext, Widget, object?, Widget> - skipped (requires specific marshaling)
