...
/// * [ExpansionTile], a Material-styled widget that expands and collapses.
	public class Expansible : StatefulWidget
	{
		...
		public Expansible(
			...
			Func<BuildContext, Animation, Widget> headerBuilder = null,
			Func<BuildContext, Animation, Widget> bodyBuilder = null,
			TimeSpan? duration = null,
			Curve curve = null,
			Curve? reverseCurve = null,
			bool maintainState = true,
			Func<BuildContext, Widget, Widget, Animation, Widget> expansibleBuilder = null
		)
		{
			...
			// Complex callback type: Func<BuildContext, Animation, Widget> - skipped (requires specific marshaling)
			// Complex callback type: Func<BuildContext, Animation, Widget> - skipped (requires specific marshaling)
			...
			// Complex callback type: Func<BuildContext, Widget, Widget, Animation, Widget> - skipped (requires specific marshaling)
		}
