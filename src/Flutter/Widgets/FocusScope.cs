...
/// policy for a widget subtree.
	public class FocusScope : StatefulWidget
	{
		...
		public FocusScope(
			...
			Func<FocusNode, object, KeyEventResult> onKey = null,
		...
		)
		{
			...
			// Complex callback type: Func<FocusNode, KeyEvent, KeyEventResult> - skipped (requires specific marshaling)
			// Complex callback type: Func<FocusNode, object, KeyEventResult> - skipped (requires specific marshaling)
