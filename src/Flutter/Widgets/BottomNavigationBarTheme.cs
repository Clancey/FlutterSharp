...
/// of a bottom navigation bar theme.
	...
	{
		/// <summary>
		/// Initializes a new instance of the <see cref="BottomNavigationBarTheme"/> class.
		/// </summary>
		...
		{
			var s = GetBackingStruct<BottomNavigationBarThemeStruct>();
			// Complex type: object - skipped (requires marshaling)
			s.child = child;
		}

		protected override FlutterObjectStruct CreateBackingStruct() => new BottomNavigationBarThemeStruct();
	}
}
