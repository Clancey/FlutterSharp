...
/// involving [Actions].
	public class MenuBar : StatelessWidget, IEnumerable<Widget>
	{
		/// <summary>
		...
		/// Use collection initializer syntax: new MenuBar { child1, child2, child3 }
		/// </summary>
		public MenuBar()
		{
		}
		...
		)
		{
			if (children != null)
				_childrenList.AddRange(children);
			var s = GetBackingStruct<MenuBarStruct>();
		...
		protected override FlutterObjectStruct CreateBackingStruct() => new MenuBarStruct();
	}
}
