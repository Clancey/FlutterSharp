...
/// viewport.
	public class SliverFillRemaining : StatelessWidget
	{
		...
		{
			var backingStruct = GetBackingStruct<SliverFillRemainingStruct>();
			backingStruct.child = _child;
			backingStruct.hasScrollBody = _hasScrollBody;
			backingStruct.fillOverscroll = _fillOverscroll;
		}

		protected override FlutterObjectStruct CreateBackingStruct() => new SliverFillRemainingStruct();
	}
}