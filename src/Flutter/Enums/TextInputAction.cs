...
/// need to understand the underlying platforms to achieve this common behavior.
	...
	/// <summary>
	/// Extension methods for TextInputAction enum.
	/// </summary>
	public static class TextInputActionExtensions
	{
		/// <summary>
		/// Converts the enum to its Dart integer representation.
		/// </summary>
		public static int ToDartInt(this TextInputAction value)
		{
			return (int)value;
		}
		...
		/// </summary>
		public static string ToDartString(this TextInputAction value)
		{
			return value switch
			{
		...
		/// </summary>
		public static TextInputAction FromDartInt(int value)
		{
			return (TextInputAction)value;
		}

		/// <summary>
		/// Converts from a Dart string representation to the enum.
		/// </summary>
		public static TextInputAction FromDartString(string value)
		{
			return value switch
			{
				...
				_ => throw new ArgumentException($"Unknown TextInputAction value: {value}", nameof(value))
			};
		}
	}
}