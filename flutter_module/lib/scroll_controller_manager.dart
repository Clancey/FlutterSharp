...
class ScrollControllerManager {
  static final ScrollControllerManager _instance =
  ...
  ScrollController getController(
    ...
    _sendScrollUpdate(controllerId, 'attach',
        controller.hasClients ? controller.offset : 0.0, null);
  ...
  Future<void> handleScrollCommand(Map<String, dynamic> message) async {
    ...
    if (managed == null || !managed.controller.hasClients) {
      debugPrint(
          'ScrollControllerManager: Controller not found or has no clients: $controllerId');
      return;
    }
