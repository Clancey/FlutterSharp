...
final class ListenerStruct extends Struct {
  ...
  /// location.
  external Pointer<Utf8> onPointerDown;

  @Int8()
  external int hasOnPointerMove;

  ///   /// Called when a pointer that triggered an [onPointerDown] changes position.
  external Pointer<Utf8> onPointerMove;
  ...
  external Pointer<Utf8> onPointerUp;
  ...
  external Pointer<Utf8> onPointerHover;
  ...
  /// events.
  external Pointer<Utf8> onPointerSignal;
