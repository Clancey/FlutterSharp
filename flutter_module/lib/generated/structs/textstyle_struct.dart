...
final class TextStyleStruct extends Struct {
  ...
  @Int8()
  external int hasFontWeight;

  ///   /// The typeface thickness to use when painting the text (e.g., bold).
  external Pointer<Void> fontWeight;

  @Int8()
  external int hasFontStyle;

  ///   /// The typeface variant to use when drawing the letters (e.g., italics).
  external Pointer<Void> fontStyle;

  @Int8()
  external int hasLetterSpacing;
  ...
  @Int8()
  external int hasLeadingDistribution;
  ...
  external Pointer<Void> leadingDistribution;
  ...
  /// specification are resolved in [foreground]'s favor - i.e. if [foreground] is
  /// specified in one place, it will dominate [color] in another.
  external Pointer<Void> foreground;
  ...
  @Int8()
  external int hasDecorationColor;

  ///   /// The color in which to paint the text decorations.
  external Pointer<Void> decorationColor;

  @Int8()
  external int hasDecorationStyle;

  ///   /// The style in which to paint the text decorations (e.g., dashed).
  external Pointer<Void> decorationStyle;

  @Int8()
  external int hasDecorationThickness;
  ...
  external Pointer<Void> fontFeatures;

  @Int8()
  external int hasFontVariations;
  ...
  external Pointer<Void> fontVariations;

  @Int8()
  external int hasOverflow;
  ...
  @Int8()
  external int hasPackage;

  external Pointer<Utf8> package;
