...
final class FocusableActionDetectorStruct extends Struct {
  ...
  @Int8()
  external int hasOnShowFocusHighlightAction;
  ...
  external Pointer<Utf8> onShowFocusHighlightAction;

  @Int8()
  external int hasOnShowHoverHighlightAction;

  ///   /// A function that will be called when the hover highlight should be shown or hidden.
  ///
  /// This method is not triggered at the unmount of the widget.
  external Pointer<Utf8> onShowHoverHighlightAction;
