...
final class PlatformViewLinkStruct extends Struct {
  ...
  @Int8()
  external int hasSurfaceFactoryAction;

  external Pointer<Utf8> surfaceFactoryAction;

  @Int8()
  external int hasOnCreatePlatformViewAction;

  external Pointer<Utf8> onCreatePlatformViewAction;
