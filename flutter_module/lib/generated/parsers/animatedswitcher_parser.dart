...
class AnimatedSwitcherParser extends WidgetParser {
  ...
  Widget parse(IFlutterObjectStruct fos, BuildContext buildContext) {
    ...
    return AnimatedSwitcher(
      ...
      // TODO: Unknown callback type Widget Function(Widget, InvalidType) - using VoidCallback fallback
      transitionBuilder: createVoidCallback(map.transitionBuilderAction.address != 0 ? map.transitionBuilderAction.toDartString() : null),
      // TODO: Unknown callback type Widget Function(Widget?, List<Widget>) - using VoidCallback fallback
      layoutBuilder: createVoidCallback(map.layoutBuilderAction.address != 0 ? map.layoutBuilderAction.toDartString() : null),
