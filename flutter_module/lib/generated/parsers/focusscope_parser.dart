...
class FocusScopeParser extends WidgetParser {
  ...
  Widget parse(IFlutterObjectStruct fos, BuildContext buildContext) {
    ...
    return FocusScope(
      ...
      // TODO: Unknown callback type KeyEventResult Function(FocusNode, InvalidType)? - using VoidCallback fallback
      onKeyEvent: createVoidCallback(map.onKeyEventAction.address != 0 ? map.onKeyEventAction.toDartString() : null),
      // TODO: Unknown callback type KeyEventResult Function(FocusNode, InvalidType)? - using VoidCallback fallback
      onKey: createVoidCallback(map.onKeyAction.address != 0 ? map.onKeyAction.toDartString() : null),
