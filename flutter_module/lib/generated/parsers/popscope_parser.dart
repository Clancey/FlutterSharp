...
class PopScopeParser extends WidgetParser {
  ...
  Widget parse(IFlutterObjectStruct fos, BuildContext buildContext) {
    ...
    return PopScope(
      // TODO: Unknown callback type void Function(bool, T?)? - using VoidCallback fallback
      onPopInvokedWithResult: createVoidCallback(map.onPopInvokedWithResultAction.address != 0 ? map.onPopInvokedWithResultAction.toDartString() : null),
      // TODO: Unknown callback type void Function(bool)? - using VoidCallback fallback
      onPopInvoked: createVoidCallback(map.onPopInvokedAction.address != 0 ? map.onPopInvokedAction.toDartString() : null),
      canPop: map.canPop == 1,
