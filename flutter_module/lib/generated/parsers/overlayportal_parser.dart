...
class OverlayPortalParser extends WidgetParser {
  ...
  Widget parse(IFlutterObjectStruct fos, BuildContext buildContext) {
    ...
    return OverlayPortal(
      ...
      // TODO: Unknown callback type Widget Function(BuildContext) - using VoidCallback fallback
      overlayChildBuilder: createVoidCallback(map.overlayChildBuilderAction.address != 0 ? map.overlayChildBuilderAction.toDartString() : null),
