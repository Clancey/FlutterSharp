...
import '../structs/tweenanimationbuilder_struct.dart';
...
class TweenAnimationBuilderParser extends WidgetParser {
  @override
  Widget parse(IFlutterObjectStruct fos, BuildContext buildContext) {
    var map = Pointer<TweenAnimationBuilderStruct>.fromAddress(fos.handle.address).ref;
    return TweenAnimationBuilder(
      // TODO: tween is required but type 'Tween<double>' cannot be marshaled through FFI
      // This widget needs a manual wrapper to properly handle this parameter
      tween: _getTweenPlaceholder(),
  ...
  @override
  String get widgetName => "TweenAnimationBuilder";
  ...
  dynamic _getTweenPlaceholder() {
    // TODO: Provide proper default value for Tween<double>
    throw UnimplementedError('TweenAnimationBuilder.tween requires manual implementation - type Tween<double> cannot be auto-generated');
  }
  dynamic _getOnEndPlaceholder() {
    // TODO: Provide proper default value for InvalidType
    throw UnimplementedError('TweenAnimationBuilder.onEnd requires manual implementation - type InvalidType cannot be auto-generated');
  }
}
