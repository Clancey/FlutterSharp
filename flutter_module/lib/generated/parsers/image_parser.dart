...
class ImageParser extends WidgetParser {
  ...
  Widget parse(IFlutterObjectStruct fos, BuildContext buildContext) {
    ...
    return Image(
      ...
      frameBuilder: map.frameBuilderAction.address != 0 ? _createFrameBuilderCallback(map.frameBuilderAction.toDartString()) : null,
      loadingBuilder: map.loadingBuilderAction.address != 0 ? _createLoadingBuilderCallback(map.loadingBuilderAction.toDartString()) : null,
      errorBuilder: map.errorBuilderAction.address != 0 ? _createErrorBuilderCallback(map.errorBuilderAction.toDartString()) : null,
      width: map.width,
      height: map.height,
      ...
      gaplessPlayback: map.gaplessPlayback == 1,
