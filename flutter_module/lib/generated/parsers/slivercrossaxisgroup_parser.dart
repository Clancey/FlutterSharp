...
import '../structs/slivercrossaxisgroup_struct.dart';
...
class SliverCrossAxisGroupParser extends WidgetParser {
  @override
  Widget parse(IFlutterObjectStruct fos, BuildContext buildContext) {
    var map = Pointer<SliverCrossAxisGroupStruct>.fromAddress(fos.handle.address).ref;
    return SliverCrossAxisGroup(
      slivers: DynamicWidgetBuilder.buildWidgets(map.slivers.cast<ChildrenStruct>(), buildContext)
    );
  }

  @override
  String get widgetName => "SliverCrossAxisGroup";
