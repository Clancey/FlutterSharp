...
class FlexParser extends WidgetParser {
  ...
  Widget parse(IFlutterObjectStruct fos, BuildContext buildContext) {
    ...
    return Flex(
      // TODO: direction is required but type 'InvalidType' cannot be marshaled through FFI
      // This widget needs a manual wrapper to properly handle this parameter
      direction: _getDirectionPlaceholder(),
      // TODO: mainAxisAlignment is required but type 'InvalidType' cannot be marshaled through FFI
      // This widget needs a manual wrapper to properly handle this parameter
      mainAxisAlignment: _getMainAxisAlignmentPlaceholder(),
      // TODO: mainAxisSize is required but type 'InvalidType' cannot be marshaled through FFI
      // This widget needs a manual wrapper to properly handle this parameter
      mainAxisSize: _getMainAxisSizePlaceholder(),
      // TODO: crossAxisAlignment is required but type 'InvalidType' cannot be marshaled through FFI
      // This widget needs a manual wrapper to properly handle this parameter
      crossAxisAlignment: _getCrossAxisAlignmentPlaceholder(),
      textDirection: TextDirection.values[map.textDirection],
      // TODO: verticalDirection is required but type 'InvalidType' cannot be marshaled through FFI
      // This widget needs a manual wrapper to properly handle this parameter
      verticalDirection: _getVerticalDirectionPlaceholder(),
      // TODO: textBaseline is required but type 'InvalidType' cannot be marshaled through FFI
      // This widget needs a manual wrapper to properly handle this parameter
      textBaseline: _getTextBaselinePlaceholder(),
  ...
  dynamic _getDirectionPlaceholder() {
    ...
    throw UnimplementedError('Flex.direction requires manual implementation - type InvalidType cannot be auto-generated');
  }
  dynamic _getMainAxisAlignmentPlaceholder() {
    // TODO: Provide proper default value for InvalidType
    throw UnimplementedError('Flex.mainAxisAlignment requires manual implementation - type InvalidType cannot be auto-generated');
  }
  dynamic _getMainAxisSizePlaceholder() {
    // TODO: Provide proper default value for InvalidType
    throw UnimplementedError('Flex.mainAxisSize requires manual implementation - type InvalidType cannot be auto-generated');
  }
  dynamic _getCrossAxisAlignmentPlaceholder() {
    // TODO: Provide proper default value for InvalidType
    throw UnimplementedError('Flex.crossAxisAlignment requires manual implementation - type InvalidType cannot be auto-generated');
  }
  dynamic _getVerticalDirectionPlaceholder() {
    // TODO: Provide proper default value for InvalidType
    throw UnimplementedError('Flex.verticalDirection requires manual implementation - type InvalidType cannot be auto-generated');
  }
  dynamic _getTextBaselinePlaceholder() {
    // TODO: Provide proper default value for InvalidType
    throw UnimplementedError('Flex.textBaseline requires manual implementation - type InvalidType cannot be auto-generated');
  }
}
