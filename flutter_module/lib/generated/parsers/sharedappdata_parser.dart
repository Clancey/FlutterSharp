...
import '../structs/sharedappdata_struct.dart';
...
/// Enables sharing key/value data with its `child` and all of the
  ...
  /// {@end-tool}
class SharedAppDataParser extends WidgetParser {
  @override
  Widget parse(IFlutterObjectStruct fos, BuildContext buildContext) {
    var map = Pointer<SharedAppDataStruct>.fromAddress(fos.handle.address).ref;
  ...
  @override
  String get widgetName => "SharedAppData";
