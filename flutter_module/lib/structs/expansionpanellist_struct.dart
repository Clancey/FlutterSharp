...
/// FFI struct representation of ExpansionPanelList widget.
/// This struct is used to pass widget data across the FFI boundary.
final class ExpansionPanelListStruct extends Struct {
  ...
  @Int8()
  external int hasExpansionCallbackAction;
  ...
  external Pointer<Utf8> expansionCallbackAction;
  ...
  @Int8()
  external int hasInitialOpenPanelValue;

  /// The value of the panel that initially begins open. (This value is
  /// only used when initializing with the [ExpansionPanelList.radio]
  /// constructor.)
  external Pointer<Void> initialOpenPanelValue;

  /// The padding that surrounds the panel header when expanded.
  ///
  /// By default, 16px of space is added to the header vertically (above and below)
  /// during expansion.
  external Pointer<EdgeInsetsStruct> expandedHeaderPadding;
  ...
  @Int8()
  external int hasExpandIconColor;

  /// {@macro flutter.material.ExpandIcon.color}
  @Uint32()
  external int expandIconColor;
  ...
  /// Defaults to `16.0`.
  @Double()
  external double materialGapSize;
}
