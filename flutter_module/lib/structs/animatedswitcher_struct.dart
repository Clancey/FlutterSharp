...
/// FFI struct representation of AnimatedSwitcher widget.
/// This struct is used to pass widget data across the FFI boundary.
final class AnimatedSwitcherStruct extends Struct {
  ...
  external Pointer<Void> switchInCurve;

  @Int8()
  external int hasSwitchOutCurve;
  ...
  external Pointer<Void> switchOutCurve;

  @Int8()
  external int hasTransitionBuilderAction;
  ...
  external Pointer<NativeFunction<Pointer<Void> Function()>> transitionBuilderAction;

  @Int8()
  external int hasLayoutBuilderAction;
  ...
  external Pointer<NativeFunction<Pointer<Void> Function()>> layoutBuilderAction;
