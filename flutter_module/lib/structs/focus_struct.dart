...
/// FFI struct representation of Focus widget.
/// This struct is used to pass widget data across the FFI boundary.
final class FocusStruct extends Struct {
  ...
  external Pointer<NativeFunction<Pointer<Void> Function()>> onKeyEventAction;

  @Int8()
  external int hasOnKeyAction;

  external Pointer<NativeFunction<Pointer<Void> Function()>> onKeyAction;
