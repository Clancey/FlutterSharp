...
/// FFI struct representation of RawView widget.
/// This struct is used to pass widget data across the FFI boundary.
final class RawViewStruct extends Struct {
  ...
  @Int8()
  external int hasDeprecatedDoNotUseWillBeRemovedWithoutNoticePipelineOwner;

  external Pointer<Void> deprecatedDoNotUseWillBeRemovedWithoutNoticePipelineOwner;

  @Int8()
  external int hasDeprecatedDoNotUseWillBeRemovedWithoutNoticeRenderView;

  external Pointer<Void> deprecatedDoNotUseWillBeRemovedWithoutNoticeRenderView;
