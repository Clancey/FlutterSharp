...
final class TreeSliverStruct extends Struct {
  ...
  @Int8()
  external int hasTreeNodeBuilderAction;
  ...
  /// is used.
  external Pointer<NativeFunction<Pointer<Void> Function()>> treeNodeBuilderAction;

  @Int8()
  external int hasTreeRowExtentBuilderAction;
  ...
  external Pointer<NativeFunction<Pointer<Void> Function()>> treeRowExtentBuilderAction;
  ...
  external Pointer<NativeFunction<Void Function()>> onNodeToggleAction;
  ...
  @Int8()
  external int hasSemanticIndexCallbackAction;

  ///   /// {@macro flutter.widgets.SliverChildBuilderDelegate.semanticIndexCallback}
  external Pointer<NativeFunction<Pointer<Void> Function()>> semanticIndexCallbackAction;
