...
final class WidgetsAppStruct extends Struct {
  ...
  /// ),
  /// ```
  external Pointer<Utf8> pageRouteBuilderAction;
  ...
  external Pointer<Utf8> exitWidgetSelectionButtonBuilderAction;
  ...
  /// button for their design systems without requiring [WidgetInspector] to
  /// depend on the Material or Cupertino packages.
  external Pointer<Utf8> moveExitWidgetSelectionButtonBuilderAction;
  ...
  /// button for their design systems without requiring [WidgetInspector] to
  /// depend on the Material or Cupertino packages.
  external Pointer<Utf8> tapBehaviorButtonBuilderAction;
