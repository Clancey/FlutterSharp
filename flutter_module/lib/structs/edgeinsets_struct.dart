...
final class EdgeInsetsStruct extends Struct {
  ...
  external Pointer<OffsetStruct> topLeft;

  external Pointer<OffsetStruct> topRight;

  external Pointer<OffsetStruct> bottomLeft;

  external Pointer<OffsetStruct> bottomRight;
