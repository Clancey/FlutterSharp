...
/// has buttons pressed.
/// FFI struct representation of MouseRegion widget.
/// This struct is used to pass widget data across the FFI boundary.
final class MouseRegionStruct extends Struct {
  ...
  /// events.
  external Pointer<Void> onHover;

  @Int8()
  external int hasOnExit;
  ...
  external Pointer<Void> onExit;

  @Int8()
  external int hasCursor;
