...
/// {@end-tool}
/// FFI struct representation of DraggableScrollableSheet widget.
/// This struct is used to pass widget data across the FFI boundary.
final class DraggableScrollableSheetStruct extends Struct {
  ...
  @Double()
  external double initialChildSize;
  ...
  external Pointer<Void> snapSizes;

  @Int8()
  external int hasSnapAnimationDuration;
  ...
  @Int64()
  external int snapAnimationDuration;
  ...
  @Int8()
  external int shouldCloseOnMinExtent;
