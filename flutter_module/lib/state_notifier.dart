...
class StateNotifier {
  ...
  static void setValue<T>(String notifierId, T value,
  ...
  static Future<void> _notifyDotNet(String notifierId, dynamic value,
      {String? sourceWidgetId}) async {
...
class BidirectionalBinding<T> extends StatefulWidget {
  ...
  @override
  State<BidirectionalBinding<T>> createState() =>
      _BidirectionalBindingState<T>();
}
...
class _BidirectionalBindingState<T> extends State<BidirectionalBinding<T>> {
  ...
  void initState() {
    super.initState();
    _notifier = StateNotifier.of<T?>(widget.notifierId,
  ...
  void _setValue(T value) {
    StateNotifier.setValue<T>(widget.notifierId, value,
