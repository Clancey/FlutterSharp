...
class TransformParser extends WidgetParser {
  ...
  Widget parse(IFlutterObjectStruct fos, BuildContext buildContext) {
    ...
    return Transform(
      ...
      origin: map.hasOrigin != 0 && map.origin.address != 0 ? parseOffset(map.origin.ref) : null,
      ...
      filterQuality: map.hasFilterQuality != 0 ? FilterQuality.values[map.filterQuality] : null,
