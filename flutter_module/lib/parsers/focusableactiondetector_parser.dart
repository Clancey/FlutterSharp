...
class FocusableActionDetectorParser extends WidgetParser {
  ...
  Widget parse(IFlutterObjectStruct fos, BuildContext buildContext) {
    ...
    return FocusableActionDetector(
      ...
      onShowFocusHighlight: parseInvalidType(map.onShowFocusHighlight),
      onShowHoverHighlight: parseInvalidType(map.onShowHoverHighlight),
      onFocusChange: parseInvalidType(map.onFocusChange),
      mouseCursor: parseInvalidType(map.mouseCursor),
      includeFocusSemantics: map.includeFocusSemantics
    );
  }
