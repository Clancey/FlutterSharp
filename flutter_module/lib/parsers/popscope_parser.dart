...
class PopScopeParser extends WidgetParser {
  ...
  Widget parse(IFlutterObjectStruct fos, BuildContext buildContext) {
    ...
    return PopScope(
      onPopInvokedWithResultAction: map.onPopInvokedWithResultActionAction.address != 0 ? _createOnPopInvokedWithResultCallback(map.onPopInvokedWithResultActionAction.toDartString()) : null,
      onPopInvokedAction: map.onPopInvokedActionAction.address != 0 ? _createOnPopInvokedCallback(map.onPopInvokedActionAction.toDartString()) : null,
      canPop: map.canPop == 1
    );
  }
