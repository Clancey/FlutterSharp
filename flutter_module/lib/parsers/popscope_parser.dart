...
class PopScopeParser extends WidgetParser {
  ...
  Widget parse(IFlutterObjectStruct fos, BuildContext buildContext) {
    ...
    return PopScope(
      onPopInvokedWithResultAction: map.onPopInvokedWithResultAction.address != 0 ? _createOnPopInvokedWithResultCallback(map.onPopInvokedWithResultAction.toDartString()) : null,
      onPopInvokedAction: map.onPopInvokedAction.address != 0 ? _createOnPopInvokedCallback(map.onPopInvokedAction.toDartString()) : null,
      canPop: map.canPop == 1
    );
  }
