...
class CompositedTransformFollowerParser extends WidgetParser {
  ...
  Widget parse(IFlutterObjectStruct fos, BuildContext buildContext) {
    ...
    return CompositedTransformFollower(
      link: parseInvalidType(map.link),
      showWhenUnlinked: map.showWhenUnlinked,
      targetAnchor: parseInvalidType(map.targetAnchor),
      followerAnchor: parseInvalidType(map.followerAnchor),
