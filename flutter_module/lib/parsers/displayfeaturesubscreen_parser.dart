...
class DisplayFeatureSubScreenParser extends WidgetParser {
  ...
  Widget parse(IFlutterObjectStruct fos, BuildContext buildContext) {
    var map =
        Pointer<DisplayFeatureSubScreenStruct>.fromAddress(fos.handle.address)
            .ref;
    return DisplayFeatureSubScreen(
        anchorPoint: map.hasAnchorPoint != 0 && map.anchorPoint.address != 0
            ? parseOffset(map.anchorPoint.ref)
            : null,
