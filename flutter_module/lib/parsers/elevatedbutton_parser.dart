...
import '../generated/structs/elevatedbutton_struct.dart';
import '../utils.dart';
...
class ElevatedButtonParser extends WidgetParser {
  ...
  Widget? parse(IFlutterObjectStruct fos, BuildContext buildContext) {
    final map = Pointer<ElevatedButtonStruct>.fromAddress(fos.handle.address).ref;
    ...
    return ElevatedButton(
      ...
      onHover: onHoverAction != null
          ? (isHovering) => invokeActionWithArgs(onHoverAction, {'value': isHovering})
          : null,
      onFocusChange: onFocusChangeAction != null
          ? (hasFocus) => invokeActionWithArgs(onFocusChangeAction, {'value': hasFocus})
          : null,
      autofocus: autofocus,
