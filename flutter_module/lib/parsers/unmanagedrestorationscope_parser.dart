...
class UnmanagedRestorationScopeParser extends WidgetParser {
  ...
  Widget parse(IFlutterObjectStruct fos, BuildContext buildContext) {
    ...
    return UnmanagedRestorationScope(
      ...
      bucket: map.hasBucket != 0 && map.bucket.address != 0 ? _getBucketPlaceholder() : (null as dynamic),
  ...
  dynamic _getBucketPlaceholder() {
    ...
    throw UnimplementedError('UnmanagedRestorationScope.bucket requires manual implementation - type RestorationBucket? cannot be auto-generated');
  }
}
