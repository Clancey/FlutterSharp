...
class FocusParser extends WidgetParser {
  ...
  Widget parse(IFlutterObjectStruct fos, BuildContext buildContext) {
    ...
    return Focus(
      ...
      onKeyEventAction: map.onKeyEventActionAction.address != 0 ? _createOnKeyEventCallback(map.onKeyEventActionAction.toDartString()) : null,
      onKeyAction: map.onKeyActionAction.address != 0 ? _createOnKeyCallback(map.onKeyActionAction.toDartString()) : null,
