  ...
  Widget parse(IFlutterObjectStruct fos, BuildContext buildContext) {
    ...
    return Container(
        alignment: map.hasAlignment != 0 && map.alignment.address != 0
            ...
            : null,
        padding: map.hasPadding != 0 && map.padding.address != 0
            ? parseEdgeInsetsGeometry(map.padding.ref)
            : null,
        color: map.hasColor != 0 ? Color(map.color) : null,
        decoration: map.hasDecoration != 0 && map.decoration.address != 0
            ? parseDecoration(map.decoration.ref)
            : null,
        foregroundDecoration: map.hasForegroundDecoration != 0 &&
                map.foregroundDecoration.address != 0
            ? parseDecoration(map.foregroundDecoration.ref)
            : null,
        constraints: map.hasConstraints != 0 && map.constraints.address != 0
            ? parseBoxConstraints(map.constraints.ref)
            : null,
        margin: map.hasMargin != 0 && map.margin.address != 0
            ? parseEdgeInsetsGeometry(map.margin.ref)
            : null,
        transform: map.hasTransform != 0 && map.transform.address != 0
            ? parseMatrix4(map.transform.ref)
            : null,
        transformAlignment: map.hasTransformAlignment != 0 &&
                map.transformAlignment.address != 0
