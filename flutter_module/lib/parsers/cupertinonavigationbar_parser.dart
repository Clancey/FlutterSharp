...
class CupertinoNavigationBarParser extends WidgetParser {
  ...
  Widget? parse(IFlutterObjectStruct fos, BuildContext buildContext) {
    final map = Pointer<CupertinoNavigationBarStruct>.fromAddress(fos.handle.address).ref;
    ...
    final automaticBackgroundVisibility = map.automaticBackgroundVisibility == 1;
