...
class AnimatedSwitcherParser extends WidgetParser {
  ...
  Widget parse(IFlutterObjectStruct fos, BuildContext buildContext) {
    ...
    return AnimatedSwitcher(
      ...
      transitionBuilderAction: map.transitionBuilderAction.address != 0 ? _createTransitionBuilderCallback(map.transitionBuilderAction.toDartString()) : null,
      layoutBuilderAction: map.layoutBuilderAction.address != 0 ? _createLayoutBuilderCallback(map.layoutBuilderAction.toDartString()) : null
    );
  }
