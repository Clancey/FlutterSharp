...
class AnimatedSwitcherParser extends WidgetParser {
  ...
  Widget parse(IFlutterObjectStruct fos, BuildContext buildContext) {
    ...
    return AnimatedSwitcher(
      ...
      switchInCurve: parseInvalidType(map.switchInCurve),
      switchOutCurve: parseInvalidType(map.switchOutCurve),
      transitionBuilderAction: map.transitionBuilderActionAction.address != 0 ? _createTransitionBuilderCallback(map.transitionBuilderActionAction.toDartString()) : null,
      layoutBuilderAction: map.layoutBuilderActionAction.address != 0 ? _createLayoutBuilderCallback(map.layoutBuilderActionAction.toDartString()) : null
    );
  }
