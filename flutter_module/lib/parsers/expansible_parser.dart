...
class ExpansibleParser extends WidgetParser {
  ...
  Widget parse(IFlutterObjectStruct fos, BuildContext buildContext) {
    ...
    return Expansible(
      headerBuilderAction: map.headerBuilderAction.address != 0 ? _createHeaderBuilderCallback(map.headerBuilderAction.toDartString()) : null,
      bodyBuilderAction: map.bodyBuilderAction.address != 0 ? _createBodyBuilderCallback(map.bodyBuilderAction.toDartString()) : null,
      duration: parseDuration(map.duration),
      curve: map.hasCurve == 1 ? parseCurve(map.curve.ref) : null,
      maintainState: map.maintainState == 1,
      expansibleBuilderAction: map.expansibleBuilderAction.address != 0 ? _createExpansibleBuilderCallback(map.expansibleBuilderAction.toDartString()) : null
    );
  }
