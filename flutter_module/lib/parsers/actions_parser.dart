...
class ActionsParser extends WidgetParser {
  ...
  Widget parse(IFlutterObjectStruct fos, BuildContext buildContext) {
    ...
    return Actions(
        ...
        dispatcher: map.hasDispatcher != 0 && map.dispatcher.address != 0
            ? _getDispatcherPlaceholder()
            : (null as dynamic),
        // TODO: actions uses Pointer<Void> and cannot be marshaled through FFI.
        // We only pass a placeholder when a non-null pointer is provided.
        actions: map.actions.address != 0
            ? _getActionsPlaceholder()
            : (null as dynamic),
  ...
  dynamic _getDispatcherPlaceholder() {
    ...
    throw UnimplementedError(
        'Actions.dispatcher requires manual implementation - type ActionDispatcher? cannot be auto-generated');
  }

  dynamic _getActionsPlaceholder() {
    // TODO: Provide proper default value for Map<Type, Action<Intent>>
    throw UnimplementedError(
        'Actions.actions requires manual implementation - type Map<Type, Action<Intent>> cannot be auto-generated');
  }
}
