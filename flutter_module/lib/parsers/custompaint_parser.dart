...
class CustomPaintParser extends WidgetParser {
  ...
  Widget parse(IFlutterObjectStruct fos, BuildContext buildContext) {
    ...
    return CustomPaint(
        ...
        painter: map.hasPainter != 0 && map.painter.address != 0
            ? _getPainterPlaceholder()
            : (null as dynamic),
        // TODO: foregroundPainter uses Pointer<Void> and cannot be marshaled through FFI.
        // We only pass a placeholder when a non-null pointer is provided.
        foregroundPainter:
            map.hasForegroundPainter != 0 && map.foregroundPainter.address != 0
                ? _getForegroundPainterPlaceholder()
                : (null as dynamic),
  ...
  dynamic _getPainterPlaceholder() {
    ...
    throw UnimplementedError(
        'CustomPaint.painter requires manual implementation - type CustomPainter? cannot be auto-generated');
  }

  dynamic _getForegroundPainterPlaceholder() {
    // TODO: Provide proper default value for CustomPainter?
    throw UnimplementedError(
        'CustomPaint.foregroundPainter requires manual implementation - type CustomPainter? cannot be auto-generated');
  }
}
