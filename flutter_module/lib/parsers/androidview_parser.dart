...
class AndroidViewParser extends WidgetParser {
  ...
  Widget parse(IFlutterObjectStruct fos, BuildContext buildContext) {
    ...
    return AndroidView(
      ...
      onPlatformViewCreated: parseInvalidType(map.onPlatformViewCreated),
      hitTestBehavior: parseInvalidType(map.hitTestBehavior),
      layoutDirection: parseInvalidType(map.layoutDirection),
      gestureRecognizers: parseSet(map.gestureRecognizers),
      creationParams: parsedynamic(map.creationParams),
      creationParamsCodec: parseInvalidType(map.creationParamsCodec),
