...
class ViewportParser extends WidgetParser {
  ...
  Widget parse(IFlutterObjectStruct fos, BuildContext buildContext) {
    ...
    return Viewport(
      axisDirection: parseInvalidType(map.axisDirection),
      crossAxisDirection: parseInvalidType(map.crossAxisDirection),
      anchor: map.anchor,
      offset: parseInvalidType(map.offset),
      center: parseInvalidType(map.center),
      cacheExtent: map.cacheExtent,
      cacheExtentStyle: parseInvalidType(map.cacheExtentStyle),
