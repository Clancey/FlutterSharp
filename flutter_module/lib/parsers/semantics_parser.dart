...
class SemanticsParser extends WidgetParser {
  ...
  Widget parse(IFlutterObjectStruct fos, BuildContext buildContext) {
    ...
    return Semantics(
      properties: parseInvalidType(map.properties),
      container: map.container,
      explicitChildNodes: map.explicitChildNodes,
      excludeSemantics: map.excludeSemantics,
      blockUserActions: map.blockUserActions
    );
  }
