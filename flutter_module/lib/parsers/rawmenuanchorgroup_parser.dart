...
class RawMenuAnchorGroupParser extends WidgetParser {
  ...
  Widget parse(IFlutterObjectStruct fos, BuildContext buildContext) {
    var map =
        Pointer<RawMenuAnchorGroupStruct>.fromAddress(fos.handle.address).ref;
  ...
  dynamic _getControllerPlaceholder() {
    ...
    throw UnimplementedError(
        'RawMenuAnchorGroup.controller requires manual implementation - type MenuController cannot be auto-generated');
  }
}
