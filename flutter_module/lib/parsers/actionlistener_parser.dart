...
class ActionListenerParser extends WidgetParser {
  ...
  Widget parse(IFlutterObjectStruct fos, BuildContext buildContext) {
    ...
    return ActionListener(
      listenerAction: map.listenerActionAction.address != 0 ? _createListenerCallback(map.listenerActionAction.toDartString()) : null,
      action: parseAction<Intent>(map.action)
    );
  }
