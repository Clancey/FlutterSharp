...
import '../structs/sensitivecontent_struct.dart';
...
class SensitiveContentParser extends WidgetParser {
  ...
  Widget parse(IFlutterObjectStruct fos, BuildContext buildContext) {
    var map = Pointer<SensitiveContentStruct>.fromAddress(fos.handle.address).ref;
    return SensitiveContent(
      ...
      sensitivity: map.sensitivity.address != 0 ? _getSensitivityPlaceholder() : (null as dynamic),
  ...
  dynamic _getSensitivityPlaceholder() {
    ...
    throw UnimplementedError('SensitiveContent.sensitivity requires manual implementation - type ContentSensitivity cannot be auto-generated');
  }
}
