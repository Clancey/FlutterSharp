...
class ImageParser extends WidgetParser {
  ...
  Widget parse(IFlutterObjectStruct fos, BuildContext buildContext) {
    ...
    return Image(
      frameBuilderAction: map.frameBuilderAction.address != 0 ? _createFrameBuilderCallback(map.frameBuilderAction.toDartString()) : null,
      loadingBuilderAction: map.loadingBuilderAction.address != 0 ? _createLoadingBuilderCallback(map.loadingBuilderAction.toDartString()) : null,
      errorBuilderAction: map.errorBuilderAction.address != 0 ? _createErrorBuilderCallback(map.errorBuilderAction.toDartString()) : null,
      width: map.width,
      height: map.height,
