...
class LocalizationsParser extends WidgetParser {
  ...
  Widget parse(IFlutterObjectStruct fos, BuildContext buildContext) {
    ...
    return Localizations(
      // TODO: locale uses Pointer<Void> and cannot be marshaled through FFI.
      // We only pass a placeholder when a non-null pointer is provided.
      locale: map.locale.address != 0 ? _getLocalePlaceholder() : (null as dynamic),
      // TODO: delegates uses Pointer<Void> and cannot be marshaled through FFI.
      // We only pass a placeholder when a non-null pointer is provided.
      delegates: map.delegates.address != 0 ? _getDelegatesPlaceholder() : (null as dynamic),
      isApplicationLevel: map.isApplicationLevel == 1,
