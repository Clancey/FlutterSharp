...
class LocalizationsParser extends WidgetParser {
  ...
  Widget parse(IFlutterObjectStruct fos, BuildContext buildContext) {
    ...
    return Localizations(
        ...
        locale: map.locale.address != 0
            ? _getLocalePlaceholder()
            : (null as dynamic),
        // TODO: delegates uses Pointer<Void> and cannot be marshaled through FFI.
        // We only pass a placeholder when a non-null pointer is provided.
        delegates: map.delegates.address != 0
            ? _getDelegatesPlaceholder()
            : (null as dynamic),
  ...
  dynamic _getLocalePlaceholder() {
    ...
    throw UnimplementedError(
        'Localizations.locale requires manual implementation - type Locale cannot be auto-generated');
  }

  dynamic _getDelegatesPlaceholder() {
    // TODO: Provide proper default value for List<LocalizationsDelegate<dynamic>>
    throw UnimplementedError(
        'Localizations.delegates requires manual implementation - type List<LocalizationsDelegate<dynamic>> cannot be auto-generated');
  }
}
