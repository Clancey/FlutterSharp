...
class OverlayPortalParser extends WidgetParser {
  ...
  Widget parse(IFlutterObjectStruct fos, BuildContext buildContext) {
    ...
    return OverlayPortal(
      controller: parseOverlayPortalController(map.controller),
      overlayChildBuilderAction: map.overlayChildBuilderActionAction.address != 0 ? _createOverlayChildBuilderCallback(map.overlayChildBuilderActionAction.toDartString()) : null
    );
  }
