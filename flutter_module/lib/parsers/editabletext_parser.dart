...
class EditableTextParser extends WidgetParser {
  ...
  Widget parse(IFlutterObjectStruct fos, BuildContext buildContext) {
    ...
    return EditableText(
      controller: parseTextEditingController(map.controller),
      focusNode: parseFocusNode(map.focusNode),
      obscuringCharacter: map.obscuringCharacter,
      obscureText: map.obscureText,
      textHeightBehavior: parseInvalidType(map.textHeightBehavior),
      textWidthBasis: parseInvalidType(map.textWidthBasis),
      @readOnly: map.@readOnly,
      forceLine: map.forceLine,
      toolbarOptions: parseToolbarOptions(map.toolbarOptions),
      showSelectionHandles: map.showSelectionHandles,
      showCursor: map.showCursor,
      autocorrect: map.autocorrect,
      smartDashesType: parseInvalidType(map.smartDashesType),
      smartQuotesType: parseInvalidType(map.smartQuotesType),
      enableSuggestions: map.enableSuggestions,
      style: parseTextStyle(map.style),
      undoController: parseUndoHistoryController(map.undoController),
      textAlign: parseInvalidType(map.textAlign),
      textDirection: parseInvalidType(map.textDirection),
      textCapitalization: parseInvalidType(map.textCapitalization),
      locale: parseInvalidType(map.locale),
      textScaleFactor: map.textScaleFactor,
      textScaler: parseInvalidType(map.textScaler),
      cursorColor: parseInvalidType(map.cursorColor),
      autocorrectionTextRectColor: parseInvalidType(map.autocorrectionTextRectColor),
      backgroundCursorColor: parseInvalidType(map.backgroundCursorColor),
      maxLines: map.maxLines,
      minLines: map.minLines,
      expands: map.expands,
      autofocus: map.autofocus,
      selectionColor: parseInvalidType(map.selectionColor),
      selectionControls: parseTextSelectionControls(map.selectionControls),
      keyboardType: parseInvalidType(map.keyboardType),
      textInputAction: parseInvalidType(map.textInputAction),
      onChanged: parseInvalidType(map.onChanged),
      onEditingComplete: parseInvalidType(map.onEditingComplete),
      onSubmitted: parseInvalidType(map.onSubmitted),
      onAppPrivateCommandAction: map.onAppPrivateCommandActionAction.address != 0 ? _createOnAppPrivateCommandCallback(map.onAppPrivateCommandActionAction.toDartString()) : null,
      onSelectionChangedAction: map.onSelectionChangedActionAction.address != 0 ? _createOnSelectionChangedCallback(map.onSelectionChangedActionAction.toDartString()) : null,
      onSelectionHandleTapped: parseInvalidType(map.onSelectionHandleTapped),
      groupId: parseObject(map.groupId),
      onTapOutsideAction: map.onTapOutsideActionAction.address != 0 ? _createOnTapOutsideCallback(map.onTapOutsideActionAction.toDartString()) : null,
      onTapUpOutsideAction: map.onTapUpOutsideActionAction.address != 0 ? _createOnTapUpOutsideCallback(map.onTapUpOutsideActionAction.toDartString()) : null,
      inputFormatters: parseList(map.inputFormatters),
      mouseCursor: parseInvalidType(map.mouseCursor),
      rendererIgnoresPointer: map.rendererIgnoresPointer,
      cursorWidth: map.cursorWidth,
      cursorHeight: map.cursorHeight,
      cursorRadius: parseInvalidType(map.cursorRadius),
      cursorOpacityAnimates: map.cursorOpacityAnimates,
      cursorOffset: parseInvalidType(map.cursorOffset),
      paintCursorAboveText: map.paintCursorAboveText,
      selectionHeightStyle: parseInvalidType(map.selectionHeightStyle),
      selectionWidthStyle: parseInvalidType(map.selectionWidthStyle),
      keyboardAppearance: parseInvalidType(map.keyboardAppearance),
      scrollPadding: parseInvalidType(map.scrollPadding),
      enableInteractiveSelection: map.enableInteractiveSelection,
      dragStartBehavior: parseInvalidType(map.dragStartBehavior),
      scrollController: parseScrollController(map.scrollController),
      scrollPhysics: parseScrollPhysics(map.scrollPhysics),
      scribbleEnabled: map.scribbleEnabled,
      stylusHandwritingEnabled: map.stylusHandwritingEnabled,
      autofillHints: parseIterable<String>(map.autofillHints),
      autofillClient: parseInvalidType(map.autofillClient),
      clipBehavior: map.clipBehavior,
      restorationId: map.restorationId,
      scrollBehavior: parseScrollBehavior(map.scrollBehavior),
      enableIMEPersonalizedLearning: map.enableIMEPersonalizedLearning,
      contentInsertionConfiguration: parseContentInsertionConfiguration(map.contentInsertionConfiguration),
      contextMenuBuilderAction: map.contextMenuBuilderActionAction.address != 0 ? _createContextMenuBuilderCallback(map.contextMenuBuilderActionAction.toDartString()) : null,
      spellCheckConfiguration: parseSpellCheckConfiguration(map.spellCheckConfiguration),
      magnifierConfiguration: parseTextMagnifierConfiguration(map.magnifierConfiguration),
      strutStyle: parseInvalidType(map.strutStyle),
      selectionEnabled: map.selectionEnabled
    );
  }
