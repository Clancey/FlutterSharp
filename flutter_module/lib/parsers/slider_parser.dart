...
import '../structs/slider_struct.dart';
import '../utils.dart';
...
class SliderParser extends WidgetParser {
  ...
  Widget? parse(IFlutterObjectStruct fos, BuildContext buildContext) {
    ...
    final onChangeStartAction =
        map.hasOnChangeStart == 1 ? parseString(map.onChangeStartAction) : null;

    final onChangeEndAction =
        map.hasOnChangeEnd == 1 ? parseString(map.onChangeEndAction) : null;
    ...
    return Slider(
      ...
      onChangeStart: onChangeStartAction != null
          ? (double newValue) =>
              invokeActionWithArgs(onChangeStartAction, {'value': newValue})
          : null,
      onChangeEnd: onChangeEndAction != null
          ? (double newValue) =>
              invokeActionWithArgs(onChangeEndAction, {'value': newValue})
          : null,
      divisions: divisions,
      label: label,
