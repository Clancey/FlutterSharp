...
class ImageFilteredParser extends WidgetParser {
  ...
  Widget parse(IFlutterObjectStruct fos, BuildContext buildContext) {
    ...
    return ImageFiltered(
      ...
      imageFilter: map.imageFilter.address != 0 ? _getImageFilterPlaceholder() : (null as dynamic),
  ...
  dynamic _getImageFilterPlaceholder() {
    ...
    throw UnimplementedError('ImageFiltered.imageFilter requires manual implementation - type ImageFilter cannot be auto-generated');
  }
}
