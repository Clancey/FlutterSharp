...
class InfiniteGridViewParser extends WidgetParser {
  ...
  Widget? parse(IFlutterObjectStruct fos, BuildContext buildContext) {
    var map =
        Pointer<InfiniteGridViewStruct>.fromAddress(fos.handle.address).ref;
    ...
    final childAspectRatio =
        map.childAspectRatio > 0 ? map.childAspectRatio : 1.0;
    ...
    final actualItemCount =
        hasLoadingIndicator ? itemCount - crossAxisCount : itemCount;
