...
class CupertinoTextFieldParser extends WidgetParser {
  ...
  Widget? parse(IFlutterObjectStruct fos, BuildContext buildContext) {
    final map =
        Pointer<CupertinoTextFieldStruct>.fromAddress(fos.handle.address).ref;
    ...
    // Parse placeholder
    final placeholder =
        map.hasPlaceholder == 1 ? parseString(map.placeholder) : null;
    ...
    if (map.hasClearButtonMode == 1) {
      clearButtonMode = OverlayVisibilityMode.values[map.clearButtonMode
          .clamp(0, OverlayVisibilityMode.values.length - 1)];
    }
...
class _CupertinoTextFieldWrapper extends StatefulWidget {
  ...
  @override
  State<_CupertinoTextFieldWrapper> createState() =>
      _CupertinoTextFieldWrapperState();
}

class _CupertinoTextFieldWrapperState
    extends State<_CupertinoTextFieldWrapper> {
    ...
    return CupertinoTextField(
      ...
      onSubmitted: widget.onSubmittedAction != null
          ? (value) {
              ...
              _invokeActionWithArgs(
                  widget.onSubmittedAction!, {'value': value});
            }
          : null,
