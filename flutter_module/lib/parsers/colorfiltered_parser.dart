...
class ColorFilteredParser extends WidgetParser {
  ...
  Widget parse(IFlutterObjectStruct fos, BuildContext buildContext) {
    ...
    return ColorFiltered(
      // TODO: colorFilter uses Pointer<Void> and cannot be marshaled through FFI.
      // We only pass a placeholder when a non-null pointer is provided.
      colorFilter: map.colorFilter.address != 0 ? _getColorFilterPlaceholder() : (null as dynamic),
