...
class BackdropFilterParser extends WidgetParser {
  ...
  Widget parse(IFlutterObjectStruct fos, BuildContext buildContext) {
    ...
    return BackdropFilter(
        ...
        filter: map.filter.address != 0
            ? _getFilterPlaceholder()
            : (null as dynamic),
        ...
        // We only pass a placeholder when a non-null pointer is provided.
        backdropGroupKey:
            map.hasBackdropGroupKey != 0 && map.backdropGroupKey.address != 0
                ? _getBackdropGroupKeyPlaceholder()
                : (null as dynamic),
  ...
  dynamic _getFilterPlaceholder() {
    ...
    throw UnimplementedError(
        'BackdropFilter.filter requires manual implementation - type ImageFilter cannot be auto-generated');
  }

  dynamic _getBackdropGroupKeyPlaceholder() {
    // TODO: Provide proper default value for BackdropKey?
    throw UnimplementedError(
        'BackdropFilter.backdropGroupKey requires manual implementation - type BackdropKey? cannot be auto-generated');
  }
}
