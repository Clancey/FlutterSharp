...
class BackdropFilterParser extends WidgetParser {
  ...
  Widget parse(IFlutterObjectStruct fos, BuildContext buildContext) {
    ...
    return BackdropFilter(
      // TODO: filter uses Pointer<Void> and cannot be marshaled through FFI.
      // We only pass a placeholder when a non-null pointer is provided.
      filter: map.filter.address != 0 ? _getFilterPlaceholder() : (null as dynamic),
      blendMode: BlendMode.values[map.blendMode],
      enabled: map.enabled == 1,
      // TODO: backdropGroupKey uses Pointer<Void> and cannot be marshaled through FFI.
      // We only pass a placeholder when a non-null pointer is provided.
      backdropGroupKey: map.hasBackdropGroupKey != 0 && map.backdropGroupKey.address != 0 ? _getBackdropGroupKeyPlaceholder() : (null as dynamic),
  ...
  dynamic _getBackdropGroupKeyPlaceholder() {
    ...
    throw UnimplementedError('BackdropFilter.backdropGroupKey requires manual implementation - type BackdropKey? cannot be auto-generated');
  }
}
