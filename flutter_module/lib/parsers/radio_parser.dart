...
import '../flutter_sharp_structs.dart' hide RadioStruct;
...
class RadioParser extends WidgetParser {
  ...
  Widget? parse(IFlutterObjectStruct fos, BuildContext buildContext) {
    ...
    // Parse groupValue (nullable - determines if selected)
    int? groupValue;
    ...
    // Parse toggleable (default false)
    ...
    return Radio<int>(
      ...
      onChanged: onChangedAction != null
          ? (int? newValue) => invokeActionWithArgs(onChangedAction, {'value': newValue})
          : null,
