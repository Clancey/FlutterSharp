...
class RawViewParser extends WidgetParser {
  ...
  Widget parse(IFlutterObjectStruct fos, BuildContext buildContext) {
    ...
    return RawView(
        ...
        deprecatedDoNotUseWillBeRemovedWithoutNoticePipelineOwner:
            map.hasDeprecatedDoNotUseWillBeRemovedWithoutNoticePipelineOwner !=
                        0 &&
                    map.deprecatedDoNotUseWillBeRemovedWithoutNoticePipelineOwner
                            .address !=
                        0
                ? _getDeprecatedDoNotUseWillBeRemovedWithoutNoticePipelineOwnerPlaceholder()
                : (null as dynamic),
        ...
        deprecatedDoNotUseWillBeRemovedWithoutNoticeRenderView:
            map.hasDeprecatedDoNotUseWillBeRemovedWithoutNoticeRenderView !=
                        0 &&
                    map.deprecatedDoNotUseWillBeRemovedWithoutNoticeRenderView
                            .address !=
                        0
                ? _getDeprecatedDoNotUseWillBeRemovedWithoutNoticeRenderViewPlaceholder()
                : (null as dynamic),
  ...
  dynamic _getViewPlaceholder() {
    ...
    throw UnimplementedError(
        'RawView.view requires manual implementation - type FlutterView cannot be auto-generated');
  }
  ...
  dynamic
    ...
    throw UnimplementedError(
        'RawView.deprecatedDoNotUseWillBeRemovedWithoutNoticePipelineOwner requires manual implementation - type PipelineOwner? cannot be auto-generated');
  }
  ...
  dynamic
    ...
    throw UnimplementedError(
        'RawView.deprecatedDoNotUseWillBeRemovedWithoutNoticeRenderView requires manual implementation - type RenderView? cannot be auto-generated');
  }
}
