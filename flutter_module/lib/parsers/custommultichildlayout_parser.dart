...
class CustomMultiChildLayoutParser extends WidgetParser {
  ...
  Widget parse(IFlutterObjectStruct fos, BuildContext buildContext) {
    var map =
        Pointer<CustomMultiChildLayoutStruct>.fromAddress(fos.handle.address)
            .ref;
  ...
  dynamic _getDelegatePlaceholder() {
    ...
    throw UnimplementedError(
        'CustomMultiChildLayout.delegate requires manual implementation - type MultiChildLayoutDelegate cannot be auto-generated');
  }
}
