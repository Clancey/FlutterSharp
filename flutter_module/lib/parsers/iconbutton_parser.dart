...
class IconButtonParser extends WidgetParser {
  ...
  Widget? parse(IFlutterObjectStruct fos, BuildContext buildContext) {
    ...
    final onPressedAction =
        map.hasOnPressed == 1 ? parseString(map.onPressedAction) : null;
    final onLongPressAction =
        map.hasOnLongPress == 1 ? parseString(map.onLongPressAction) : null;

    // Parse tooltip
    final tooltip = map.hasTooltip == 1 ? parseString(map.tooltip) : null;
