...
class FadeInImageParser extends WidgetParser {
  ...
  Widget parse(IFlutterObjectStruct fos, BuildContext buildContext) {
    ...
    return FadeInImage(
      placeholderErrorBuilderAction: map.placeholderErrorBuilderAction.address != 0 ? _createPlaceholderErrorBuilderCallback(map.placeholderErrorBuilderAction.toDartString()) : null,
      imageErrorBuilderAction: map.imageErrorBuilderAction.address != 0 ? _createImageErrorBuilderCallback(map.imageErrorBuilderAction.toDartString()) : null,
