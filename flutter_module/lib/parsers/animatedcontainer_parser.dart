...
class AnimatedContainerParser extends WidgetParser {
  ...
  Widget parse(IFlutterObjectStruct fos, BuildContext buildContext) {
    var map =
        Pointer<AnimatedContainerStruct>.fromAddress(fos.handle.address).ref;
    return AnimatedContainer(
        ...
        padding: map.padding.address != 0
            ? parseEdgeInsetsGeometry(map.padding.ref)
            : EdgeInsets.zero,
        decoration: map.decoration.address != 0
            ? parseDecoration(map.decoration.ref)
            : const BoxDecoration(),
        foregroundDecoration: map.foregroundDecoration.address != 0
            ? parseDecoration(map.foregroundDecoration.ref)
            : const BoxDecoration(),
        constraints: map.constraints.address != 0
            ? parseBoxConstraints(map.constraints.ref)
            : const BoxConstraints(),
        margin: map.margin.address != 0
            ? parseEdgeInsetsGeometry(map.margin.ref)
            : EdgeInsets.zero,
        transform: map.transform.address != 0
            ? parseMatrix4(map.transform.ref)
            : Matrix4.identity(),
        transformAlignment: map.transformAlignment.address != 0
            ? parseAlignmentGeometry(map.transformAlignment.ref)
            : Alignment.center,
  ...
  dynamic _getAlignmentPlaceholder() {
    ...
    throw UnimplementedError(
        'AnimatedContainer.alignment requires manual implementation - type AlignmentGeometry cannot be auto-generated');
  }
}
