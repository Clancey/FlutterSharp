...
namespace Flutter.Internal {
	...
	public unsafe partial class GeneratedPluginRegistrant : NSObject {
		...
		static readonly IntPtr class_ptr = Class.GetHandle ("GeneratedPluginRegistrant");
		...
		[BindingImpl (BindingImplOptions.GeneratedCode | BindingImplOptions.Optimizable)]
		[EditorBrowsable (EditorBrowsableState.Advanced)]
		protected internal GeneratedPluginRegistrant (IntPtr handle) : base (handle)
		{
			IsDirectBinding = GetType ().Assembly == global::ApiDefinition.Messaging.this_assembly;
		}
		...
		public static void Register (FlutterEngine engine)
		{
			...
			global::ApiDefinition.Messaging.void_objc_msgSend_IntPtr (class_ptr, Selector.GetHandle ("registerWithRegistry:"), engine__handle__);
		}
