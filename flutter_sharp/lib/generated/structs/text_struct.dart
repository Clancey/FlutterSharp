...
class TextStruct extends StatelessWidgetStruct {
  /// The text to display.
...
```
{@endtemplate}
  external Pointer<Void> semanticsLabel;
...
dynamic in nature.
  external Pointer<Void> semanticsIdentifier;
