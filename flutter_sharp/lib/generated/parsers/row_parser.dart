...
/// Parser that converts RowStruct to Row widget.
class RowParser implements WidgetParser {
  @override
  Widget parse(Pointer<Void> structPtr) {
    if (structPtr.address == 0) {
      throw ArgumentError('Null pointer passed to RowParser');
    }

    final struct = structPtr.cast<RowStruct>().ref;
